  ...
  <div id="product_form">
    <form action="" method="post">
      ...
      <div id="form-group">
        ...
        <input type="text" name="sku" id="sku" placeholder="XER2345" maxlength="7"><br>
        ...
        <div id="dvd-info" class="d-none" style="display: none;">
          <label for="size">Size (MB)</label>
          <input type="text" name="size" id="size" placeholder="product size in MB"><br>
          <h3>Please, provide size in MB</h3>
        </div>
        <div id="furniture-info" class="d-none" style="display: none;">
          <label for="height">Height (CM)</label>
          <input type="text" name="height" id="height" placeholder="product size in height CM"><br>
          <label for="width">Width (CM)</label>
          <input type="text" name="width" id="width" placeholder="product size in width CM"><br>

          <label for="length">Length (CM)</label> 
          <input type="text" name="length" id="length" placeholder="product size in length CM"><br>
          <h3>Please, provide dimensions in HxWxL format</h3>
        </div>
        <div id="book-info" class="d-none" style="display: none;">
          <label for="weight">Weight (KG)</label>
          <input type="text" name="weight" id="weight" placeholder="product size in weight KG"><br>
